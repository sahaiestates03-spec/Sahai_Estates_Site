...
export default function PropertyDetailsPage() {
  ...
  useEffect(() => {
    const cr = property.price / 10_000_000;
    document.title = `${property.title} | ₹${cr.toFixed(2)} Cr | Sahai Estates`;
    const desired = `Luxury ${property.propertyType?.toLowerCase()} in ${property.location}: ${property.bedrooms} bed, ${property.bathrooms} bath, ~${property.areaSqft} sq ft. Enquire with Sahai Estates.`;
  ...
  const whatsappNumber = '919920214015'; // change if needed (country code + number, no +)
